...
def test_keys(api_key, api_secret, label):
    """Test a set of API keys"""
    print(f"\n{'='*60}")
...
def main():
    ...
    # Test old keys first
    old_works = test_keys(old_key, old_secret, "OLD KEYS (from .env.example)")
    
    # Test new keys
    new_works = test_keys(new_key, new_secret, "NEW KEYS (your fresh keys)")

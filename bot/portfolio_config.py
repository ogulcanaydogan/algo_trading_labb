...
EXAMPLE_CRYPTO_PORTFOLIO = Portfolio(
    ...
    assets=[
        Asset(
            symbol="BTC/USDT", asset_type=AssetType.CRYPTO, data_source="binance", allocation_pct=50
        ),
        Asset(
            symbol="ETH/USDT", asset_type=AssetType.CRYPTO, data_source="binance", allocation_pct=30
        ),
        Asset(
            symbol="SOL/USDT", asset_type=AssetType.CRYPTO, data_source="binance", allocation_pct=20
        ),
    ],
)
...
EXAMPLE_MULTI_ASSET_PORTFOLIO = Portfolio(
    ...
    assets=[
        Asset(
            symbol="BTC/USDT", asset_type=AssetType.CRYPTO, data_source="binance", allocation_pct=30
        ),
        Asset(
            symbol="AAPL", asset_type=AssetType.EQUITY, data_source="yfinance", allocation_pct=25
        ),
        Asset(
            symbol="GC=F", asset_type=AssetType.COMMODITY, data_source="yfinance", allocation_pct=20
        ),
